...
import effluent2 from "@/assets/images/tratamento de efluentes 2.jpg";
import buildings from "@/assets/images/edificações.jpg";
import buildingsEffluent from "@/assets/images/edicicaoes + efluente.jpg";
import cacoal from "@/assets/images/SOLO RLP Cacoal - Outubro22 (182) (1).jpg";

export const metadata: Metadata = { title: "Sobre a NCF" };
const gallery: { src: StaticImageData; alt: string; label: string }[] = [
  { src: hero, alt: "Vista aérea da operação da NCF Ambiental", label: "Estrutura ambiental" }, { src: fleet, alt: "Frota da NCF Ambiental", label: "Frota operacional" }, { src: compactor, alt: "Caminhão compactador", label: "Coleta com compactador" }, { src: containerTruck, alt: "Caminhão de contêiner", label: "Transporte de contêineres" }, { src: rollOn, alt: "Caminhão Roll-On/Roll-Off", label: "Operação Roll-On/Roll-Off" }, { src: landfill, alt: "Célula de disposição final", label: "Disposição final" }, { src: landfill2, alt: "Célula em operação", label: "Célula em operação" }, { src: effluent, alt: "Tratamento de efluentes", label: "Tratamento de efluentes" }, { src: effluent2, alt: "Lagoas de tratamento", label: "Lagoas de tratamento" }, { src: buildings, alt: "Edificações da unidade", label: "Infraestrutura" }, { src: buildingsEffluent, alt: "Unidade operacional", label: "Unidade operacional" }, { src: cacoal, alt: "Unidade da NCF em Cacoal", label: "Unidade Cacoal" },
];
