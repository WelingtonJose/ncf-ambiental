    ...
    <section className="section-shell py-20">
      <div className="grid gap-12 lg:grid-cols-2">
        <div>
          ...
          <p className="section-copy">A NCF não executa poda, varrição, limpeza de quintais, limpeza de terrenos ou obras. O cliente entrega o material já gerado, separado e acessível para que nossa equipe faça a coleta e a destinação adequada.</p>
          <CheckList items={[
        ...
        <Specs items={[
          { title: "Preparação", text: "O resíduo deve estar separado, organizado e disponível em local com acesso seguro." },
          { title: "Locação", text: "A equipe indica a lixeira ou o recipiente adequado após avaliar material e volume." },
          { title: "Agendamento", text: "A retirada ou entrega do recipiente é combinada após a aprovação do orçamento." },
          { title: "Destinação", text: "Cada material coletado segue para a destinação compatível e autorizada." },
        ]} />
      </div>
    </section>
  </>;
