...
export const sectorImages = {
  "comercios-e-mercados": { src: commerces, alt: "Coleta comercial programada em comércio e supermercado" },
  "escritorios-e-empresas": { src: offices, alt: "Coleta organizada em escritório e centro empresarial" },
  "restaurantes-e-hoteis": { src: restaurantsHotels, alt: "Coleta programada na área de serviço de hotel e restaurante" },
  industrias: { src: industries, alt: "Operação de contêiner para resíduos industriais" },
  "obras-e-grandes-geradores": { src: construction, alt: "Posicionamento de contêiner em obra de grande porte" },
